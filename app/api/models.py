...
class Message(BaseModel):
    ...
    content: Optional[Union[str, List[Dict[str, Any]]]] = Field(
        None,
        description="The contents of the message. Can be a string, an array of content parts, or None for assistant tool calls.",
    )
    name: Optional[str] = Field(None, description="The name of the author or tool.")
